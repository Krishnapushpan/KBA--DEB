  ...
  <>
   <div className="bg-white text-gray-900 mb-10 pb-10">   
    ...
    (<div className="flex flex-row justify-end gap-4 mr-[205px] ">
     ...
     <Link onClick={deleteCourse} to='/home' className="flex bg-red-500 hover:bg-red-600 text-white font-bold  rounded-full h-10 w-32 focus:outline-none focus:shadow-outline  justify-center items-center" >Remove Course
     </Link>
      </div>)
      }
  </div>
...
const courseLoader = async ({params}) =>{
  ...
  if(!res.ok){
    throw new Response("cousres not found",{status:404})
  }
  return res.json();
}
